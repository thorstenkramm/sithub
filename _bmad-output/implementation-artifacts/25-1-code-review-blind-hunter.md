...
- You have no project context, no spec, and no repository access.
- Review adversarially for likely bugs, regressions, broken UX flows, unclear behavior, and implementation risks that can be inferred from the diff alone.
- Output findings as a Markdown list.
- Each finding should include a short title and concise evidence from the diff.
